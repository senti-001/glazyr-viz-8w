...
const systemModules = [
  ...
  { name: "Tier-4 CI/CD", status: "nominal", uptime: "99.99%", icon: Server },
  { name: "Cascade Engine", status: "nominal", uptime: "99.95%", icon: Cpu },
  { name: "Hyperion Cluster", status: "nominal", uptime: "99.99%", icon: Wifi },
]
    ...
    <section id="pulse" className="relative py-24 px-6">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="text-muted-foreground max-w-xl mb-10 leading-relaxed">
          Our agents run on a <strong>Tier-4 Hardened CI/CD pipeline</strong>, ensuring 99.9% uptime for the Glazyr Hyperion cluster.
        </p>
