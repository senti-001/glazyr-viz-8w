...
import { Brain, Sparkles, MessageSquare, Phone, Layers, ArrowUpRight } from "lucide-react"
...
const capabilities = [
  ...
  },
  {
    ...
    description:
      "High-intent users trigger the Sovereign Link, initiating the proactive AI callback cascade via SMS/Voice.",
  },
  {
    icon: Layers,
